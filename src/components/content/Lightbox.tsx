...
/**
 * Shared full-screen photo viewer for `PhotoGalleryRenderer` and
 * `StackWidget`. Plain `fixed inset-0` overlay + framer-motion — no
 * portal-positioning helper needed (AD-11).
 */
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <Image src={photos[index]} alt="" fill className="object-contain" />
        </motion.div>
      </motion.div>
    </AnimatePresence>
  )

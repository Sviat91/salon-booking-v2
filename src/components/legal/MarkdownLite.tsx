...
/**
 * Renders `parseMarkdownLite()`'s node tree as React elements — never
 * `dangerouslySetInnerHTML`. Classes mirror the previous hand-written JSX in
 * `/terms` and `/privacy` so the visual output is unchanged.
 */

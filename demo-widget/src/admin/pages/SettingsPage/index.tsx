...
// Homepage widget, Light Theme, Dark Theme Colors, then Security below an
// <hr>, matching the real page.tsx). Every field the real page has is shown
// with its real label; only Salon Name and the two accent colors ("Primary
// Button" / "Dark Primary Button" — the real field names) are actually
// editable, matching what was asked. Everything else (Brand's logo/favicon/
// theme-toggle-icon controls, the Background fields, and Security) is
// visually present but fully inert — see BrandSection.tsx, BackgroundField.tsx
// and SecuritySection.tsx.
